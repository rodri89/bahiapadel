...
<div class="ticket-body-inner" data-venta-id="{{ $vid }}" data-modo-grupo="1">
            ...
            >
                ...
                <div class="mt-2 pt-2 border-top">
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-2">
                        <span class="caja-texto-small">Consumo este jugador: <strong>{{ $fmtMoney($subPart) }}</strong></span>
                    </div>
                    <div class="ticket-jugador-pago-acciones d-flex flex-wrap align-items-center justify-content-end">
                        ...
                        @else
                            ...
                            @else
                                <button type="button" class="btn btn-success btn-participante-pago mr-1" data-participante-id="{{ $p->id }}" data-metodo="efectivo">Pagar todo ({{ $fmtMoney($subPendiente) }})</button>
                                <button type="button" class="btn btn-info btn-participante-pago" data-participante-id="{{ $p->id }}" data-metodo="transferencia">Pagar todo ({{ $fmtMoney($subPendiente) }})</button>
                            @endif
                        @endif
                    </div>
                </div>
    ...
    <div class="table-responsive mb-2">
        <table class="table table-sm table-bordered mb-0">
            <thead class="thead-light"><tr><th>Producto</th><th class="text-center">Cant.</th><th class="text-right">Subtotal</th><th class="text-center">Estado</th><th class="text-center p-1" style="width:120px"></th></tr></thead>
    ...
    <small class="caja-texto-small d-block">Tocá <strong>J1–J4</strong> para ver el nombre, la búsqueda y el cobro de ese jugador. Cargá productos con <strong>+</strong>. El ticket se cierra cuando los cuatro estén pagados (o “Sin consumo”).</small>
</div>

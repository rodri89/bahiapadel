...
<div class="ticket-body-inner" data-venta-id="{{ $vid }}" data-modo-grupo="0">
    ...
    <div class="table-responsive mb-2">
        <table class="table table-sm table-bordered mb-0">
            <thead class="thead-light"><tr><th>Producto</th><th class="text-center">Cant.</th><th class="text-right">Subtotal</th><th class="text-center">Estado</th><th class="text-center p-1" style="width:100px"></th></tr></thead>
    ...
    <small class="caja-texto-small d-block">Cada clic en <strong>+</strong> agrega 1 unidad del producto elegido. Podés quitar una línea con <strong>−</strong>. <strong>Cancelar ticket</strong> elimina la venta y devuelve el stock. El nombre se guarda con <strong>Guardar</strong> o al salir del campo cliente.</small>
</div>
@endif
